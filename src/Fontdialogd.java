	...
	//	 Font.setPreferredSize(new  Dimension(2,25));
        ...
        button1.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				String str=frameMain.text.getText();
				JLabel strla=new JLabel(str);
				frameMain.text.setFont(viewla.getFont());
				frameMain.text.setForeground(viewla.getForeground());
			    if(jcb1.isSelected())
			    { 
			    	hm2.put(TextAttribute.UNDERLINE, TextAttribute.UNDERLINE_ON);  // 定义下划线 
		             font = new Font(hm2); 
		            frameMain.text.setFont(font);
			    }
			    ...
			    {
			       frameMain.text.setFont(font);
			       String ss=frameMain.text.getText();
			       frameMain.text.setText(new letertochange().ChangetoLO(ss));
			    }
			    else if(jrb2.isSelected())
			    {
			    	...
			    	frameMain.text.setFont(font);
				    String ss=frameMain.text.getText();
				    frameMain.text.setText(new letertochange().ChangetoUP(ss));
			    }
